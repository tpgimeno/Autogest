...
class VehiclesCest
{
    ...
    public function SaveVehicleTest(FunctionalTester $I){
        ...
        $I->submitForm('#VehicleForm', array ('registry_date' => '2016/04/06','plate' => $matricula, 'vin' => $bastidor, 'brand' => 'FIAT', 'model' => 'DUCATO', 'description' => 'L3H2 130cv Furgón 35 3p', 'type' => 'Furgon', 'store' => 'Automotive', 'Kilómetros' => '45.728', 'power' => '130', 'places' => '3', 'doors' => '4', 'color' => 'Blanco', 'cost' => '10.000,00€', 'tvaBuy' => '2.100,00€', 'totalBuy' => '12.100,00€', 'pvp' => '12.500,00€', 'tvaSell' => '2.625,00€', 'totalSell' => '15.125,00€', 'acc-aire-acondicionado' => true));
