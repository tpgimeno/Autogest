...
final class WorkSheetsTable extends AbstractMigration
{
    ...
    public function change(): void
    {
        ...
        $table->addColumn('workSheetNumber', 'string')
                ...
                ->addColumn('baseWorkSheet', 'float', ['null' => true])
                ->addColumn('discountWorkSheet', 'float', ['null' => true])
                ->addColumn('tvaWorkSheet', 'float', ['null' => true])
                ->addColumn('totalWorkSheet', 'float', ['null' => true])
