    ...
    public function change()
    {
        ...
        $table->addColumn('brand_id', 'integer')
                ...
                ->addColumn('cost', 'float', ['null' => true, 'default' => null])
                 ->addColumn('costTva', 'float', ['null' => true, 'default' => null])
                 ->addColumn('costTotal', 'float', ['null' => true, 'default' => null])
                ->addColumn('vehiclePvp', 'float', ['null' => true, 'default' => null])
                 ->addColumn('discount', 'float', ['null' => true, 'default' => null])
                 ->addColumn('tva', 'float', ['null' => true, 'default' => null])
