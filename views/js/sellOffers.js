...
{            
    ...
    {                      
        ...
        request.open('POST', '/intranet/sells/offers/customer/search', true);
        ...
        else
        {
            ...
            function reqListener()
            {
                ...
                {                          
                   ...
                   {
                       table.innerHTML += "<tr><td>"+response[i]['name']+"</td><td>"+response[i]['city']+"</td><td>"+response[i]['fiscal_id']+"</td><td>"+response[i]['address']+"</td><td><a href=/intranet/sells/offers/customer/select?customer_id="+response[i]['id']+"&offer_id={{offer.id}}&vehicle_id={{vehicle.id}}>Select</a></td></tr>";
                   }                               
                }                        
            }
    ...
    {                      
        var request = new XMLHttpRequest();
        request.open('POST', '/intranet/sells/offers/vehicle/search', true);
        request.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
        ...
        else
        {
            ...
            function reqListener()
            {
                ...
                {                          
                   for(let i = 0; i < response.length ; i++)
                   {
                       table.innerHTML += "<tr><td>"+response[i]['plate']+"</td><td>"+response[i]['vin']+"</td><td>"+response[i]['brand']+"</td><td>"+response[i]['model']+"</td><td><a href=/intranet/sells/offers/customer/select?customer_id="+response[i]['id']+"&offer_id={{offer.id}}&customer_id={{customer.id}}>Select</a></td></tr>";
                   }                               
                }                        
            }
            request.addEventListener("load", reqListener);
   ...
   numeral.register('locale', 'es', {
    ...
    if(json_supplies_response)
    {
        ...
        {            
            ...
            table_supplies.innerHTML += "<tr><td>"+offer_supplies[i]['supplyId']+"</td><td>"+offer_supplies[i]['reference']+"</td><td>"+offer_supplies[i]['name']+"</td><td>"+numeral(offer_supplies[i]['price']).format('(0.0,$)')+"</td><td>"+offer_supplies[i]['cantity']+"</td><td>"+numeral(offer_supplies[i]['total']).format('(0.0,$)')+"</td><td><a href=/intranet/sells/offers/supplies/edit?supply_id="+offer_supplies[i]['supplyId']+"&offer_id="+numeral(offer.value).value()+"&vehicle_id="+numeral(id_vehicle.value).value()+"&component_id="+numeral(id_component.value).value()+"&work_id="+numeral(id_work.value).value()+"&customer_id="+numeral(id_customer.value).value()+">Edit</a></td><td><a href=/intranet/sells/offers/supplies/del?supply_id="+offer_supplies[i]['supplyId']+"&offer_id="+numeral(offer.value).value()+"&vehicle_id="+numeral(id_vehicle.value).value()+"&component_id="+numeral(id_component.value).value()+"&work_id="+numeral(id_work.value).value()+"&customer_id="+numeral(id_customer.value).value()+">Eliminar</a></td>";
    ...
    if(json_components_response)
    {
        ...
        {            
            ...
            table_components.innerHTML += "<tr><td>"+offer_components[i]['componentId']+"</td><td>"+offer_components[i]['reference']+"</td><td>"+offer_components[i]['name']+"</td><td>"+numeral(offer_components[i]['price']).format('(0.0,$)')+"</td><td>"+offer_components[i]['cantity']+"</td><td>"+numeral(offer_components[i]['total']).format('(0.0,$)')+"</td><td><a href=/intranet/sells/offers/components/edit?component_id="+numeral(offer_components[i]['componentId']).value()+"&offer_id="+numeral(offer.value).value()+"&vehicle_id="+numeral(id_vehicle.value).value()+"&customer_id="+numeral(id_customer.value).value()+"&supply_id="+numeral(id_supply.value).value()+"&work_id="+numeral(id_work.value).value()+">Edit</a></td><td><a href=/intranet/sells/offers/components/del?component_id="+numeral(offer_components[i]['componentId']).value()+"&offer_id="+numeral(offer.value).value()+"&vehicle_id="+numeral(id_vehicle.value).value()+"&customer_id="+numeral(id_customer.value).value()+"&supply_id="+numeral(id_supply.value).value()+"&work_id="+numeral(id_work.value).value()+">Eliminar</a></td>";
...
function addWork()
{
    ...
    document.getElementById("inputTotal").value = total.format('(0.0,$)');
    var request = new XMLHttpRequest();    
    request.open('POST', '/intranet/sells/offers/works/add', true);
    request.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");    
