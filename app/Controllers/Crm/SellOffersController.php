...
//            var_dump($postData);die();
            try
            {
                 ...
                 if($offer->id)
                 {
                     $offer_temp = SellOffer::find($offer->id);
                     if($offer_temp)
                     {
                         $offer = $offer_temp;
                         $offer_selected = true;
    ...
    {        
        ...
        $offerSupplies = DB::table('selloffers_supplies')                
            ...
            ->join('maders', 'supplies.mader', '=', 'maders.id')
            ->select('selloffers_supplies.id', 'selloffers_supplies.selloffer_id', 'selloffers_supplies.supply_id', 'supplies.ref as reference', 'maders.name as mader', 'supplies.name as name', 'selloffers_supplies.cantity as cantity', 'selloffers_supplies.price as price')
            ->where('selloffers_supplies.selloffer_id', '=', $postData['id'])                              
            ->get()->toArray();
        $offerComponents = DB::table('selloffers_components')
            ...
            ->where('selloffers_components.selloffer_id', '=', $postData['id'])                
            ->get()->toArray();
        $offerWorks = DB::table('selloffers_works')
            ...
            ->where('selloffers_works.selloffer_id', '=', $postData['id'])                
            ->get()->toArray();
        array_push($postData, $offerSupplies, $offerComponents, $offerWorks, $accesories_withkeys);
    ...
    {        
        ...
        if($selected_offer === null)
        {
            ...
            if($last_offer === null)
            {
                ...
                $offer_number = $offerString.$stringNumber;
        ...
        if(isset($params['supply_id']))
        {
            ...
            if(isset($params['supply_price']))
            {
                if($params['supply_price'] !== 'null')
                {
            ...
            if(isset($params['supply_cantity']))
            {
                if($params['supply_cantity'] !== 'null')
                {
        ...
        {
            if($params['component_id'] !== 'null')
            {
                $selected_component = Components::find($params['component_id']);
            }            
            if(isset($params['component_price']))
            {
                if($params['component_price'] !== 'null')
                {
            ...
            if(isset($params['component_cantity']))
            {
                if($params['component_cantity'] !== 'null')
                {
        ...
        {
            if($params['work_id'] !== 'null')
            {
                $selected_work = Works::find($params['work_id']);
            }            
            if(isset($params['work_price']))
            {
                if($params['work_price'] !== 'null')
                {
            ...
            if(isset($params['work_cantity']))
            {
                if($params['work_cantity'] !== 'null')
                {
        ...
        if($selected_offer)
        {
            ...
            $accesories = explode(", ", $selected_vehicle->accesories);            
            foreach($accesories as $key => $acc)
            {            
               $key = $acc;  
               $accesories_withkeys[$key] = $acc;
        ...
        try
        {
            $offerSupplies = DB::table('selloffers_supplies')                
                ...
                ->join('maders', 'supplies.mader', '=', 'maders.id')
                ->select('selloffers_supplies.id', 'selloffers_supplies.selloffer_id', 'selloffers_supplies.supply_id', 'supplies.ref as reference', 'maders.name as mader', 'supplies.name as name', 'selloffers_supplies.cantity as cantity', 'selloffers_supplies.price as price')
                ->where('selloffers_supplies.selloffer_id', '=', $new_offer)                              
                ->get();
            $offerComponents = DB::table('selloffers_components')
                ->join('components', 'selloffers_components.component_id', '=', 'components.id')
                ->join('maders', 'components.mader', '=', 'maders.id')
                ->select('selloffers_components.id', 'selloffers_components.selloffer_id', 'selloffers_components.component_id', 'components.ref as reference', 'components.name as name', 'selloffers_components.cantity as cantity', 'selloffers_components.price as price')
                ->where('selloffers_components.selloffer_id', '=', $new_offer)                
                ->get();
            $offerWorks = DB::table('selloffers_works')
                ->join('works', 'selloffers_works.work_id', '=', 'works.id')               
                ->select('selloffers_works.id', 'selloffers_works.selloffer_id', 'selloffers_works.work_id', 'works.description as description', 'selloffers_works.cantity as cantity', 'selloffers_works.price as price')
                ->where('selloffers_works.selloffer_id', '=', $new_offer)                
                ->get();           
